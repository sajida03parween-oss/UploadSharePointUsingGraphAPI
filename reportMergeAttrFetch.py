...
def export_table(conn, table_name, columns, lookup_cache, input_df):
    ...
    try:
        ...
        with open(csv_file, mode="w", newline="", encoding="utf-8-sig") as file:
            ...
            for _, row_input in input_df.iterrows():
                tdmx_id = row_input["TDMX_ID"]
                revision = row_input["Revision"]
...
def main():
    ...
    try:
        ...
        for table_name, columns in TABLE_CONFIG.items():
            export_table(conn, table_name, columns, lookup_cache, input_df)
